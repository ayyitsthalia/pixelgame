...
def talk_to_mom ():
    ...
    message_to_screen("type G to say 'I love both of you so I decide to live alone.'", white, 0, size = "okie")
    message_to_screen("type H to say 'I want to live with both of you guys. I love you both!'", white, 20, size = "okie")
...
def talk_to_fairy ():
    ...
    message_to_screen("type I to choose the drawing", white, 0, size = "okie")
    message_to_screen("type J to choose the bracelet", white, 20, size = "okie")
